        ...
        <div class="col-md-10">
        	...
        	<div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Submit Your Site For Review</h3>
              </div>
              <div class="panel-body">
                
					{!! Form::open(['route'=>'submitsite.store']) !!}
						{{ csrf_field() }}

					<h4> Please Select Plan :
						<select name="ddlViewBy" required>
						  <option value="0">Submit Site For Free Review Plan</option>
						  <option value="1">Submit Site For Text Review Plan</option>
						  <option value="2">Submit Site For Video Review Plan</option>
						</select>
					</h4>					

					<div class="form-group {{ $errors->has('websitename') ? 'has-error' : '' }}">
						{!! Form::label('Website Name:') !!}
						{!! Form::text('websitename', old('websitename'), ['class'=>'form-control', 'placeholder'=>'Enter Website Name'])  !!}
					...
					<div class="form-group">
						<button class="btn btn-success">Submit For Review Plan!</button>
					</div>
