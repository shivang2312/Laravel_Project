@extends('usermain')
@section('title', 'Text Payment Page')
@section('content')
      ...
      <div class="container-fuild">
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Text Review Plan</h3>
              </div>
        ...
        <form action="{{ route('pay', $product->id) }}" method="POST">
            ...
            <div class="col-sm-5 col-md-5">
                        <div class="thumbnail">
                            <div class="caption">
                                <h3>Buy Text Review Plan</h3>
                                <p>You will get the following Reviews in Text Review panel-heading</p>
                                <ul>
